...
- **Live Application**: [Open App](https://spendee-dashboard-219154903837.southamerica-west1.run.app)
- **Monitoring & Logs**: [Cloud Run Console](https://console.cloud.google.com/run/detail/southamerica-west1/spendee-dashboard/logs?project=clear-data-485013)
...
- **Service URL**: [https://spendee-dashboard-219154903837.southamerica-west1.run.app](https://spendee-dashboard-219154903837.southamerica-west1.run.app)
- **Region**: `southamerica-west1` (Santiago)
- **Secrets**: Managed via **GCP Secret Manager** (`spendee-dashboard-secrets`).
